...
/*
 * Logic linked to the ComboBox of the recipe editor and allows you to copy the selected recipe to the EditModel.
 */

public class RecipesComboBoxLogic : FTOptix.NetLogic.BaseNetLogic
{
